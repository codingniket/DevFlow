...
const LeftSidebar = () => {
  return ( 
    ...
    justify-between overflow-y-auto border-r border-light-400 p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
     ...
     <div className="flex flex-col gap-3">
                ...
                <Button className="small-medium btn-secondary w-full px-4 py-3 rounded-lg min-h-[41px] shadow-none" asChild>
